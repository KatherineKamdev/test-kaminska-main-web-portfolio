...
export const TabPaneWrapperSection = (): JSX.Element => {
  return (
    <section className="relative w-full min-h-[845px] bg-gradient-to-bl from-[#2c2922] to-[#2a2520] py-24 px-16">
      <div className="absolute inset-0 opacity-5">
        <div className="absolute inset-0" style={{
          backgroundImage: `radial-gradient(circle at 70% 60%, rgba(140, 150, 233, 0.1) 0%, transparent 50%)`
        }} />
      </div>
        ...
        <div className="flex-1 flex flex-col gap-12 max-w-3xl">
          <div className="flex flex-col gap-6">
            ...
            <p className="text-neutral-100 text-xl leading-relaxed [font-family:'Red_Rose',Helvetica] font-normal">
              User research, competitive analysis, and strategic frameworks
              create the blueprint. Decisions are made with evidence, not
              assumptions.
            </p>
          </div>

          <div className="relative h-[380px] bg-gradient-to-br from-[#3a3530] to-[#2a2520] rounded-2xl overflow-hidden shadow-2xl">
